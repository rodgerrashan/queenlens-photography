...
export default function Intro() {
    return (
        ...
        <div>
                    <div >
                    <h2 className= {`${cinzelFont.className} pt-6 text-3xl font-bold text-center text-gray-950 px-8`}>Queenlens Photography Services</h2>
        ...
        {services.map((service, index) => (
          <Link
            ...
            href={service.link}>
              <div
            key={index}
            className="text-center max-w-md py-5 border-2 border-blue-950 p-2 rounded-lg shadow-lg transform transition-all duration-500 hover:scale-105 hover:bg-gray-950 hover:text-gray-50"
          >
            <h2 className= {`${montserratAlternatesFont.className} text-2xl font-semibold mb-4 px-2 `}>{service.title}</h2>
