...
export default function MoreShots() {
    return (
        <section className="bg-blue-950 p-4 text-center text-gray-50 display flex flex-col justify-center items-center mt-10">
          <div className=" mb-1 max-w-lg md:max-w-2xl">
        ...
        <div className="bg-slate-100  w-auto h-auto px-5 py-1 rounded-2xl">
          <div className="text-blue-950 text-xl text-center  font-bold">
